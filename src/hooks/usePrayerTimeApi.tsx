...
export default function usePrayerTimeApi() {
    ...
    async function getRawTimings(latitude: number, longitude: number) {
        ...
        const url = `https://api.aladhan.com/v1/calendar/${year}/${month}?latitude=${latitude}&longitude=${longitude}&school=1&&latitudeAdjustmentMethod=3&tune=5,2,0,4,0,4,0,2,0&iso8601=true`;
